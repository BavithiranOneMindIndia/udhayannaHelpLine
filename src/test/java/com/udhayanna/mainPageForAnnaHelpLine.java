...
public class mainPageForAnnaHelpLine extends superClass {
        ...
        public void clickCreateNew_admin(WebDriver driver) throws IOException {
                getwaitdriver(driver).until(ExpectedConditions
                                .visibilityOfElementLocated(getValueFromElementAddressConfig("admin.createNew")));
                driver.findElement(getValueFromElementAddressConfig("admin.createNew")).click();
        }

        public void enterMobile_admin(WebDriver driver) throws IOException {
                getwaitdriver(driver).until(ExpectedConditions.visibilityOfElementLocated(
        ...
        public void clickCreate_admin(WebDriver driver) throws IOException {
                getwaitdriver(driver).until(ExpectedConditions
                                .visibilityOfElementLocated(getValueFromElementAddressConfig("admin.create.admin")));
                driver.findElement(getValueFromElementAddressConfig("admin.create.admin")).click();
        }
