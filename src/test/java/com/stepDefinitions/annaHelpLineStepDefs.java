...
import com.udhayanna.mainPageForAnnaHelpLine;
...
public class annaHelpLineStepDefs extends mainPageForAnnaHelpLine {
    ...
    public void click_splashScreen() throws IOException, InterruptedException {
    ...
    public void enter_mobile_in_admin() throws IOException {
        enterMobile_admin(driver);
    }

    @Then("enter name in admin")
    public void enter_name_in_admin() throws IOException {
        enterName_admin(driver);
    }

    @Then("Select issue Category")
    public void select_issueCategory_admin() {
        select_issueCategory_admin(driver);
    }
